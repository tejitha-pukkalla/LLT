...
//     description: 'We provide comprehensive cybersecurity solutions to safeguard your business from evolving threats. From vulnerability assessments to compliance management, we ensure your digital infrastructure remains secure and resilient.',
//     features: [
...
//     ],
//     technologies: ['OWASP', 'Metasploit', 'Burp Suite', 'Nessus', 'Wireshark', 'Splunk', 'CrowdStrike'],
//     process: [
//       { step: 'Assessment', desc: 'Identifying existing security gaps and risks' },
//       { step: 'Planning', desc: 'Designing a tailored security strategy' },
//       { step: 'Implementation', desc: 'Deploying security tools and controls' },
//       { step: 'Testing', desc: 'Penetration testing and vulnerability scans' },
//       { step: 'Compliance', desc: 'Ensuring regulatory and industry standards' },
//       { step: 'Monitoring', desc: 'Continuous threat detection and response' }
//     ],
...
//     description: 'We provide round-the-clock technical support and maintenance services to keep your applications running smoothly. Our dedicated team ensures maximum uptime, fast bug resolution, and continuous performance improvements.',
//     features: [
...
//     ],
//     technologies: ['Jira', 'Zendesk', 'PagerDuty', 'New Relic', 'Datadog', 'Grafana', 'Sentry'],
//     process: [
//       { step: 'Onboarding', desc: 'Understanding your system and SLA requirements' },
//       { step: 'Monitoring', desc: 'Setting up real-time system monitoring' },
//       { step: 'Issue Tracking', desc: 'Logging and prioritizing reported issues' },
//       { step: 'Resolution', desc: 'Fast bug fixes and patch deployments' },
//       { step: 'Optimization', desc: 'Performance tuning and code improvements' },
//       { step: 'Reporting', desc: 'Monthly health reports and recommendations' }
//     ],
...
export default function ServiceDetail() {
  ...
  return (
    <>
    <SEOHead page="serviceDetail" slug={slug} />
    <div className={`pt-32 pb-20 ${isDark ? 'bg-gray-950' : 'bg-white'}`}>
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        {/* Breadcrumb */}
        <motion.div
