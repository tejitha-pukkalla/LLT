...
const seoData = {
  home: {
    title: 'LogicLife Technologies | Web & Mobile App Development Company in Visakhapatnam',
    description:
      'LogicLife Technologies — Top software development company in Visakhapatnam. We build websites, mobile apps, custom software & digital marketing solutions. Get a free consultation.',
    keywords:
      'web development company visakhapatnam, mobile app development visakhapatnam, software company vizag, digital marketing visakhapatnam, IT company andhra pradesh',
  ...
  about: {
    ...
    description:
      'Learn about LogicLife Technologies — 8+ years of experience, 150+ projects delivered, 50+ team members. A trusted digital solutions partner in Visakhapatnam, Andhra Pradesh.',
    keywords:
      'about logiclife technologies, IT company vizag, software development team visakhapatnam',
  ...
  services: {
    ...
    description:
      'Comprehensive digital services: Web Development, Mobile App Development, Custom Software, UI/UX Design, Digital Marketing, Cloud Services & Cybersecurity in Visakhapatnam.',
    keywords:
      'web development services visakhapatnam, mobile app development, software development vizag, digital marketing agency visakhapatnam, cloud services andhra pradesh',
  ...
  portfolio: {
    ...
    description:
      'Explore our portfolio of 150+ successful web and mobile app projects across e-commerce, healthcare, education, fintech and more. Built by LogicLife Technologies.',
    keywords:
      'logiclife technologies portfolio, software projects vizag, mobile app portfolio india, web development portfolio visakhapatnam',
  ...
  technologies: {
    ...
    description:
      'Our tech stack includes React, Next.js, Flutter, Node.js, Python, AWS, Azure and more. LogicLife Technologies uses modern technologies to build future-ready solutions.',
    keywords:
      'react development visakhapatnam, flutter app development, node.js developers vizag, aws cloud services india',
  ...
  careers: {
    ...
    description:
      'Join LogicLife Technologies! Open positions for Full Stack Developers, React Native Developers, UI/UX Designers & DevOps Engineers in Visakhapatnam & Remote.',
    keywords:
      'software jobs visakhapatnam, developer jobs vizag, IT jobs andhra pradesh, react developer jobs, flutter developer jobs visakhapatnam',
  ...
  contact: {
    ...
    description:
      'Contact LogicLife Technologies for web development, mobile apps, software solutions & digital marketing in Visakhapatnam. Call +91 95029 24788 or email us today.',
    keywords:
      'contact logiclife technologies, web development consultation visakhapatnam, software company contact vizag, IT services enquiry',
  ...
  // ── ServiceDetail pages (slug-based) ──────────────────────────────────────
  serviceWebDevelopment: {
    title: 'Web Development Services in Visakhapatnam | LogicLife Technologies',
    description:
      'Custom web application development using React, Next.js, Node.js & more. LogicLife Technologies builds scalable, high-performance websites in Visakhapatnam.',
    keywords:
      'web development visakhapatnam, react development vizag, next.js developers andhra pradesh, website design company visakhapatnam',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=web-development',
  },

  serviceMobileApps: {
    title: 'Mobile App Development in Visakhapatnam | React Native & Flutter — LogicLife',
    description:
      'iOS & Android mobile app development using React Native and Flutter. Build cross-platform mobile apps with LogicLife Technologies, Visakhapatnam.',
    keywords:
      'mobile app development visakhapatnam, react native developers vizag, flutter app development andhra pradesh, ios android app company',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=mobile-apps',
  },

  serviceSoftwareDevelopment: {
    title: 'Custom Software Development Visakhapatnam | ERP, CRM — LogicLife Technologies',
    description:
      'Custom software solutions — ERP systems, CRM tools, automation and legacy modernization. LogicLife Technologies delivers enterprise software in Visakhapatnam.',
    keywords:
      'custom software development visakhapatnam, erp development vizag, crm software andhra pradesh, enterprise software company india',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=software-development',
  },

  serviceDigitalMarketing: {
    title: 'Digital Marketing Company in Visakhapatnam | SEO, PPC, Social Media — LogicLife',
    description:
      'Data-driven digital marketing services: SEO, Google Ads, Social Media Marketing, Content Marketing. Grow your business online with LogicLife Technologies, Visakhapatnam.',
    keywords:
      'digital marketing company visakhapatnam, seo services vizag, google ads visakhapatnam, social media marketing andhra pradesh, content marketing india',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=digital-marketing',
  },

  serviceUiUxDesign: {
    title: 'UI/UX Design Services Visakhapatnam | Figma, Prototyping — LogicLife Technologies',
    description:
      'User-centered UI/UX design — wireframing, prototyping, design systems and usability testing. Beautiful and intuitive digital experiences by LogicLife Technologies.',
    keywords:
      'ui ux design visakhapatnam, figma designers vizag, website design company andhra pradesh, app ui design india',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=ui-ux-design',
  },

  serviceCloudServices: {
    title: 'Cloud Services & DevOps Visakhapatnam | AWS, Azure — LogicLife Technologies',
    description:
      'Cloud migration, infrastructure setup, DevOps and CI/CD pipelines on AWS, Azure and Google Cloud. Reliable cloud solutions by LogicLife Technologies, Visakhapatnam.',
    keywords:
      'cloud services visakhapatnam, aws services vizag, azure devops andhra pradesh, cloud migration company india',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=cloud-services',
  },

  serviceCybersecurity: {
    title: 'Cybersecurity Services Visakhapatnam | Security Audits & Penetration Testing',
    description:
      'Comprehensive cybersecurity solutions: security audits, penetration testing, compliance management. Protect your digital assets with LogicLife Technologies.',
    keywords:
      'cybersecurity company visakhapatnam, penetration testing india, security audit vizag, it security andhra pradesh',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=cybersecurity',
  },

  serviceSupportMaintenance: {
    title: '24/7 IT Support & Maintenance Services | LogicLife Technologies Visakhapatnam',
    description:
      'Round-the-clock technical support and maintenance for web apps, mobile apps and software. Bug fixes, updates and performance optimization by LogicLife Technologies.',
    keywords:
      'it support visakhapatnam, software maintenance vizag, website support andhra pradesh, 24/7 technical support india',
    canonical: 'https://www.logiclifetechnologies.com/service-detail?slug=support-maintenance',
  },
};

// ── Slug → SEO key mapping ─────────────────────────────────────────────────
const slugToSeoKey = {
...
// ── Shared Open Graph & Schema values ─────────────────────────────────────
const SITE_NAME = 'LogicLife Technologies';
const LOGO_URL  = 'https://www.logiclifetechnologies.com/logo_transparent.png';
const OG_IMAGE  = 'https://www.logiclifetechnologies.com/og-image.jpg'; // 1200×630 image create చేయండి
...
export default function SEOHead({ page, slug, title, description, keywords, canonical }) {
  ...
  } else if (page && seoData[page]) {
    seo = seoData[page];
  }

  // Allow prop overrides
  const finalTitle       = title       || seo.title       || `${SITE_NAME} | Digital Solutions`;
  const finalDescription = description || seo.description || 'LogicLife Technologies — Web, Mobile & Software Development in Visakhapatnam.';
  ...
  return (
    <Helmet>
      ...
      {/* ── Geo tags (local SEO for Visakhapatnam) ── */}
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "logo": LOGO_URL,
          "description": "Leading software development company in Visakhapatnam specializing in web development, mobile apps, digital marketing and cloud services.",
          "address": {
            "@type": "PostalAddress",
...
//   // ✅ CLIENT REQUIRED: exact title & description
//   home: {
